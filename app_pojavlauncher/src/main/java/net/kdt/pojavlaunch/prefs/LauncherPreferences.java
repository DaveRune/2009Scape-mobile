...
public class LauncherPreferences {
    ...
    public static float PREF_SCROLL_SENSITIVITY = 1f;
    public static boolean PREF_SCROLL_INVERT = false;
    ...
    public static void loadPreferences(Context ctx) {
        ...
        PREF_SCROLL_SENSITIVITY = ((float)DEFAULT_PREF.getInt("scrollSensitivity", 100))/100f;
        PREF_SCROLL_INVERT = DEFAULT_PREF.getBoolean("scrollInvert", false);
